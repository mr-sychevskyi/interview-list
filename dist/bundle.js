...
exports.dataBaseUrl = undefined;

var _templateList = __webpack_require__(340);

var _templateList2 = _interopRequireDefault(_templateList);

var _interviewPlate = __webpack_require__(341);

var _interviewPlate2 = _interopRequireDefault(_interviewPlate);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const dataBaseUrl = exports.dataBaseUrl = 'https://api.mlab.com/api/1/databases/interview-data/collections/Interviews?apiKey=OC9zdRla3z_mJLnJolHefCGgrKx7MOlH';
...
class InterviewsList {
    ...
    getList() {
        fetch(dataBaseUrl).then(res => res.json()).then(res => {
            this.list = res;
            this.drawList();
        });
    }
    ...
    drawList() {
        if (this.body) {
            this.body.innerHTML = (0, _templateList2.default)(this.list);
            ...
            this.list.forEach(interview => {
                if (parentCurrentList) {
                    const card = new _interviewPlate2.default(interview, parentCurrentList);
                    card.render();
                }
            });
            ...
            if (parentNewCardList) {
                const cardNew = new _interviewPlate2.default(interviewForm, parentNewCardList, parentCurrentList);
                cardNew.render();
            }
        }
    }
}
exports.default = InterviewsList;
...
var _interviewsList = __webpack_require__(130);

var _interviewsList2 = _interopRequireDefault(_interviewsList);
...
exports.default = interviews => {
    return `
        <h1 class="title-primary">List of interviews</h1>
        <div class="interview-list">
            <div class="interview-list__item interview-list__current"></div>
           
            <span class="separator"></span>
            
            <div class="interview-list__item interview-list__newcard"></div>
        </div>`;
};
...
var _templateCard = __webpack_require__(342);
...
class InterviewPlate {
    ...
    constructor(interview, parent, parentCurrentList) {
    ...
    render() {
        if (this.id === 'createNew') {
            this.card.innerHTML = (0, _templateCard2.default)(this.interview, true);
            this.addNewCardListener();
        } else {
            this.card.innerHTML = (0, _templateCard2.default)(this.interview);
            this.addCardListeners();
        }
    }

    add() {
        fetch(_interviewsList.dataBaseUrl, {
            method: 'POST',
            headers: {
    ...
    remove() {
        if (confirm('Are you sure?')) {
            fetch(this.cardUrl, {
                method: 'DELETE'
            }).then(() => this.destroy()).catch(err => console.log(err));
        }
    }
    ...
    erase() {
        [...this.card.querySelectorAll('.form-control')].forEach(item => {
            if (item instanceof HTMLInputElement) item.value = '';else if (item instanceof HTMLTextAreaElement) item.value = '';
        });
    }
    ...
    edit() {
        ...
        [...this.card.querySelectorAll('.form-control')].forEach(item => {
            if (item instanceof HTMLInputElement) item.readOnly = !this.editMode;else if (item instanceof HTMLTextAreaElement) item.readOnly = !this.editMode;
        });
    }

    cancel() {
        fetch(this.cardUrl).then(res => res.json()).then(res => {
            this.card.innerHTML = (0, _templateCard2.default)(res);
            this.addCardListeners();
        });
    }

    get currentCardValues() {
        ...
        if (fullName && fullName instanceof HTMLInputElement && birthDate && birthDate instanceof HTMLInputElement && phoneNumber && phoneNumber instanceof HTMLInputElement && interviewNotes && interviewNotes instanceof HTMLTextAreaElement) {
            return {
...
exports.default = InterviewPlate;
...
exports.default = (interview, cardToForm = false) => {
    return `
        ...
        ${cardToForm ? `<div class="interview-card__controls interview-card__new">
            <a class='btn btn-add' href="#">&#x2795;</a>
        </div>` : `<div class="interview-card__controls">
